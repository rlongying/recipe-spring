package learn.spring.recipe.bootstrap;

import learn.spring.recipe.model.*;
import learn.spring.recipe.repository.CategoryRepository;
import learn.spring.recipe.repository.RecipeRepository;
import learn.spring.recipe.repository.UnitOfMeasureRepository;
...
//        log.debug("Loading Bootstrap Data");
    ...
    private RuntimeException throwUOMNotFoundRuntimeException() {
    ...
    private List<Recipe> getRecipes() {
        ...
        //get optionals
        UnitOfMeasure eachUom = eachUomOptional.orElseThrow(this::throwUOMNotFoundRuntimeException);
        UnitOfMeasure tableSpoonUom = tableSpoonUomOptional.orElseThrow(this::throwUOMNotFoundRuntimeException);
        UnitOfMeasure teapoonUom = tableSpoonUomOptional.orElseThrow(this::throwUOMNotFoundRuntimeException);
        UnitOfMeasure dashUom = dashUomOptional.orElseThrow(this::throwUOMNotFoundRuntimeException);
        UnitOfMeasure pintUom = dashUomOptional.orElseThrow(this::throwUOMNotFoundRuntimeException);
        UnitOfMeasure cupsUom = cupsUomOptional.orElseThrow(this::throwUOMNotFoundRuntimeException);
